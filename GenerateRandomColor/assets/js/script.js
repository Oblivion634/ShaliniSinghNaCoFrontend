...
if (webbutton) {
  webbutton.addEventListener("click", () => {
    ...
    // Select <main> and the button container
    let main = document.querySelector("main");
    let buttonContainer = document.querySelector(".trigger-button");

    // Create a container to display the color grid
    ...
    colorGrid.style.width = "90%"; // Takes 80% width of main
    ...
    // Append the color grid below the button
...
function generateRandomColor() {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    inner_new_element.style.border = "1px solid black";
